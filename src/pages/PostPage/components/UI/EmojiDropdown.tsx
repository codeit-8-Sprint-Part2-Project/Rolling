...
function EmojiDropdown({ data }: { data: ReactionCreate | null }) {
  ...
  return (
    <>
      ...
      {isDropdownVisible && (
        <div className="max-w-[226px] md:max-w-[360px] flex flex-wrap gap-2.5 rounded-lg border border-[#b6b6b6] shadow-custom p-3 md:p-6 bg-white absolute top-10 md:left-[-60px]">
